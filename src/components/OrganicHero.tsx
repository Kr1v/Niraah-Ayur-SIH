          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-xl">
                ...
                <span className="text-vibrant-teal font-semibold">
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 bg-${item.color}/20 rounded-full flex items-center justify-center group-hover:animate-float`}
                    >
            ...
            <div className="flex items-center gap-8 pt-8">
              {[
                ...
                <div key={index} className="text-center group">
                  <div
                    className={`text-3xl font-space font-bold text-${stat.color} group-hover:animate-pulse`}
                  >
                    {stat.value}
                  </div>
